...
class JwtAuthFilterTest {
    ...
    @Test
    void filter_validToken_setsCatalogPrincipalAuthentication() throws Exception {
        ...
        assertThat(auth.getPrincipal()).isInstanceOf(CatalogPrincipal.class);
        CatalogPrincipal p = (CatalogPrincipal) auth.getPrincipal();
